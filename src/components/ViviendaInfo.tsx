...
export default function ViviendaInfo({ hogarId }: { hogarId: number }) {
  ...
  return (
    <div className="space-y-5">
      {/* Materiales y tipo */}
      <Seccion titulo="Características de la Vivienda">
        <Campo label="Condición" value={data.condicion_vivienda} />
      ...
      {/* Composicion */}
      <Seccion titulo="Composición del Hogar">
        ...
        <Campo label="Niños" value={data.ninos} />
        <Campo label="Niñas" value={data.ninas} />
      ...
      <Seccion titulo="Servicios y Cocina">
        ...
        <Campo label="Usa Leña" value={data.usa_lenia} />
        ...
        <Campo label="Días sin Agua" value={data.dias_sin_agua} />
        ...
        <Campo label="Días sin Electricidad" value={data.dias_sin_electricidad} />
        <Campo label="Eliminación Basura" value={data.eliminacion_basura} />
      </Seccion>
      ...
      <div>
        ...
        <div className="flex flex-wrap gap-1.5">
          ...
          <BienBadge label="Estufa Leña" value={data.estufa_lenia} />
      ...
      <Seccion titulo="Seguridad Alimentaria (ELCSA)">
        <Campo label="Preocupación Alimentos" value={data.preocupacion_alimentos} />
        <Campo label="Sin Alimentos" value={data.sin_alimentos} />
        <Campo label="Adulto sin Alimentación Saludable" value={data.adulto_sin_alimentacion_saludable} />
        <Campo label="Niño sin Alimentación Saludable" value={data.nino_sin_alimentacion_saludable} />
        <Campo label="Adulto sin Variedad" value={data.adulto_sin_variedad} />
        <Campo label="Niño sin Variedad" value={data.nino_sin_variedad} />
        <Campo label="Adulto sin Tiempo Comida" value={data.adulto_sin_tiempo_comida} />
        <Campo label="Niño sin Tiempo Comida" value={data.nino_sin_tiempo_comida} />
        <Campo label="Adulto Comió Menos" value={data.adulto_comio_menos} />
        <Campo label="Niño Comió Menos" value={data.nino_comio_menos} />
        <Campo label="Adulto Sintió Hambre" value={data.adulto_sintio_hambre} />
        <Campo label="Niño Sintió Hambre" value={data.nino_sintio_hambre} />
        <Campo label="Adulto Comió Una Vez" value={data.adulto_comio_una_vez} />
        <Campo label="Niño Comió Una Vez" value={data.nino_comio_una_vez} />
      </Seccion>
    </div>
  )
}
